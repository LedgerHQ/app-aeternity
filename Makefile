...
APP_LOAD_PARAMS= --curve ed25519 --path "44'/457'" --appFlags 0x240 $(COMMON_LOAD_PARAMS)
...
ifeq ($(TARGET_NAME),TARGET_NANOX)
	ICONNAME=nanox_app_aeternity.gif
else
	ICONNAME=nanos_app_aeternity.gif
endif
