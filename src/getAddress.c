...
const bagl_element_t ui_address_nanos[] = {
    ...
    {{BAGL_LABELINE    , 0x02,  23,  26,  82,  12, 0x80|10, 0, 0  , 0xFFFFFF, 0x000000, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px|BAGL_FONT_ALIGNMENT_CENTER, 26  }, (char*)tmpCtx.addressContext.address, 0, 0, 0, NULL, NULL, NULL },
};
