...
if [ -d clang-arm-fropi -a -d gcc-arm-none-eabi-5_3-2016q1 -a -d nanos-secure-sdk-nanos-1421 ]; then
...
wget https://github.com/LedgerHQ/nanos-secure-sdk/archive/nanos-1421.tar.gz
